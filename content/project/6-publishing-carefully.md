...
The printing of the 300 texts was done in an open session, using a solar panel to print outside when the weather allowed. The session took about 30 hours, using two colour bands and old tractor paper.
